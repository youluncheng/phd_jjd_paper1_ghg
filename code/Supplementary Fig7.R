...
all_colors_pop <- c(
  "Historical population"= "#7C7979", 
  "High fertility scenario" = "#387877", 
  "Medium fertility scenario" = "#447294", 
  "Low fertility scenario" = "#E16A4D"
)
...
message(paste("：", output_path_final))
